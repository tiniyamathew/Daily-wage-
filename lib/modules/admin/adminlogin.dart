...
class _AdminLoginState extends State<AdminLogin> {
  ...
  Future<bool> _signInWithEmailAndPassword(
    ...
    try {
      ...
      if (adminQuery.docs.isNotEmpty) {
        ...
        // For example, using a library like 'bcrypt' for password hashing
  ...
  bool verifyPassword(String inputPassword, String storedPassword) {
    // Implement proper password hashing here (e.g., using 'bcrypt')
    // For simplicity, we compare the plain text passwords in this example
